...
#include <time.h>
#include <conio.h>
char ch[5][130]={"Shimla Travels @1000/-","Chandigarh Travels @800/-","Jaipur Express @400/-","Agra Express @400/-","Dehradun Travels @500/-"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
    printf("================================== WELCOME TO FRIENDS BUS RESERVATION SYSTEM ==================================\n\n\n");
...
void booking()
{
    ...
    char numstr[100];
    system("cls");
    printf("======================================= FRIENDS BUS RESERVATION SYSTEM ========================================\n\n\n");//for entering train number
    ...
    else
    {
        ...
        switch(trno)
        {
            case 1: printf("\n\t\t\t\tThe Total booking amount is %d",1000*booking);
                    break;
            case 2: printf("\n\t\t\t\tThe Total booking amount is %d",800*booking);
                    break;
...
int read_number(int trno)//for putting the numeric value in the array
{
    ...
    strcat(numstr,".txt");
    strcat(tempstr2,numstr);
    a = fopen(tempstr2,"a+");//for open the file to write the seat number in the file
    while(!feof(a))
    {
        number[i][j] = fgetc(a);
        if(number[i][j] == ' ')
...
void status()
{
    ...
    printf("                                  Bus.no --> %d ----> %s                                                            \n",trno,ch[trno-1]);
    printf("____________________________________________________________________________________________________________________\n");
    char tempname[33][10]={"  [O]  ","  [O]  ","  [O]  ","  [O]  ","  [O]  ","  [O]  ","  [O]  ","  [O]  ","  [O]  ","  [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "," [O]  "};
    for(i=0; i<j; i++)
    {
...
void cancel()
{
    ...
    {
        case 1: printf("======================================================================================================\n");
                printf("\t\t\t\tYour 1000 rupees has been Returned\t\t\t\n");
                printf("======================================================================================================\n");
                break;
        case 2: printf("======================================================================================================\n");
                printf("\t\t\t\tYour 800 rupees has been Returned\t\t\t\n");
                printf("======================================================================================================\n");
                break;
        case 3: printf("======================================================================================================\n");
                printf("\t\t\t\tYour 400 rupees has been Returned\t\t\t\n");
                printf("======================================================================================================\n");
                break;
        case 4: printf("======================================================================================================\n");
                printf("\t\t\t\tYour 400 rupees has been Returned\t\t\t\n");
...
void login()
{
	...
	if (count>3)
	{
        ...
        {
            system("cls");
            printf("\n\n\tPlease try again in %d seconds!!!",10-i);
            Sleep(1000);
        }
        system("cls");
        login();
